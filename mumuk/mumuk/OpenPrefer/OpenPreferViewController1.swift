...
class OpenPreferViewController1 : UIViewController {
    ...
    var openPreferModel : OpenPreferModel = OpenPreferModel()
    ...
    let lineImage : UIImageView = {
         let lineImage = UIImageView()
         lineImage.image = UIImage(named: "openline1")
...
//        if let exceptionalFoodsList = openPreferModel.exceptionalFoods {
//                // exceptionalFoodsList를 사용하여 원하는 작업을 수행
//                print("exceptionalFoods: \(exceptionalFoodsList)")
//            } else {
//                // openPreferModel이 nil이거나 exceptionalFoods가 nil일 때 처리할 작업
//                print("exceptionalFoods 리스트에 접근할 수 없습니다.")
//            }
