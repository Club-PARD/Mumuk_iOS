...
////  mumuk
////
////  Created by 유재혁 on 7/6/24.
////
//
//import UIKit
//
//class EditController: UIViewController, UITextFieldDelegate, ModalImageSelectDelegate {
//    var memos: [NameModel] = []
...
//        textField.delegate = self // 이 부분 추가해서 키보드 확인시 내려가게
//        textField.returnKeyType = .done // 이 부분을 추가하여 키보드에 "확인" 버튼을 표시
//        return textField
//    }()
//
//
...
//            view.endEditing(true)
//        }
//    // Return 키가 눌렸을 때 호출되는 델리게이트 메서드
//    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
//        // Return 키를 누르면 키보드가 내려가고 LoginButtonPressed 메서드가 호출됩니다.
